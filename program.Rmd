...
keynote <- tribble(~"구분", ~"시간", ~"발표자명", ~"소속", ~"발표제목", ~"국가", ~"파일명",
                   "오프닝", "10:00~10:05", "이광춘", "R 사용자회", "### 오프닝", "한국", "kwangchun_lee.jpg",
                   "키노트", "10:05~11:00", "Julia Silge", "RStudio", "### Data visualization for machine learning practitioners", "미국", "julia_silge.png",
...
program_tbl_gt %>% 
  ...
  tab_source_note(
    source_note =  md("**R 사용자회**: 코로나 19로 인해 일부 동영상 녹화 발표가 실시간 라이브로 배정되었습니다. 상기 발표내용은 사정에 따라 변경될 수 있습니다.")
  ) %>% 
  tab_options(
    heading.background.color = "#1E61B0", # R logo 파란색
    heading.title.font.size = "32px",
